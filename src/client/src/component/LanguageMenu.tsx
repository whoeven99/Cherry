  ...
  return (
    <Stack>
      <Stack horizontal verticalAlign='center' tokens={{ childrenGap: 8 }}>
        ...
        <Link href='https://support.microsoft.com/en-us/office/what-languages-is-office-available-in-26d30382-9fba-45dd-bf55-02ab03e2a7ec' target="_blank" className='language__link'>Learn more</Link>
      </Stack>
